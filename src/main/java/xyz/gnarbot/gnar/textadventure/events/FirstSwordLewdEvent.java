...
public class FirstSwordLewdEvent extends Event
{
    ...
    {
        super.sendMessage(n, ":bulb: " + "Resting, you suddenly notice a dildo on the ground.\n" + "However, in these" +
                " woods, there's no one around.\n" + "Yet, your heart throbs, the urge to do so is profound.\n" +
                "Will your pride be renowned?" + "\n   :warning: What would you like to do?\n  " + "➜ `Pick it up`\n " +
                " ➜ `Leave it`\n  ➜ `Examine it`\n  ➜ `Use it`\n \n " + ":bulb: `Use the _adventure command to select" +
                " a response! Example: _adventure Pick it up`");
        return this;
    }
    ...
    public void parseResponse(Adventure adventure, Note n, String response)
    {
        ...
        if (!(response.equalsIgnoreCase("pick it up")
                ...
                || response.equalsIgnoreCase("use it")))
        {
        ...
        else
        {
            ...
            {
                super.sendMessage(n, "    :asterisk: You compel yourself to leave the Dildo, even though it looks " +
            ...
            else if (response.equalsIgnoreCase("use it"))
            {
                adventure.sendMessage(n, "    :warning: You slowly creep towards it... with your heart beating faster" +
                        ".\n" + " You start to notice that your legs have been trembling ever since laying your eyes " +
                        "on it's shaft.\n" + " You poke it... breathing heavily. You notice it has a slight wobble, " +
                        "despite it being made of steel.\n" + " You hear a voice calling towards you *\"Ussseeee ittt" +
                        ". Usseeee itt! Use it and become one with me!\"*\n" + " You look around, seeing nobody, " +
            ...
            {
                if (adventure.getInventory().addItem(new Item("Cracked Steel Dildo", "Dildo", "A Dildo that fell from" +
                        " the sky", 1)) != -1)
                {
                ...
                {
                    super.sendMessage(n, "        :asterisk: You pick up the Dildo and attempt to store it, before " +

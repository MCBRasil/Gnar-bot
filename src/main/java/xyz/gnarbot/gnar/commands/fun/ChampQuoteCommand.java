...
public class ChampQuoteCommand extends CommandExecutor {
    ...
    public void execute(Note msg, String label, String[] args) {
        ...
        } catch (Exception e) { msg.replyRaw("Odd, you should have never got here. For getting here and some how butchering that champions name so bad, here's a cookie :cookie:"); e.printStackTrace(); }
    }

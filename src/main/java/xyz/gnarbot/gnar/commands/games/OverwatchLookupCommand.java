...
public class OverwatchLookupCommand extends CommandExecutor
{
    public void execute(Note note, String label, String[] args)
    {
        ...
        try
        {
            ...
            //Note m = note.info("Finding that player...");
            ...
            joiner.add("Battle Tag: **__[" + tag + "](https://playoverwatch.com/en-gb/career/pc/"
                    + region.toLowerCase() + "/" + tag.replaceAll("#", "-") + ")__**");
            
            joiner.add("Region: **__["
                    + region.toUpperCase() + "](http://masteroverwatch.com/leaderboards/pc/"
            ...
            joiner.add("  Wins/Draws/Loses: **["
                    + compGameStats.optInt("games_won")  + "]()** | **["
            ...
            note.replyEmbedRaw("**Overwatch Stats: " + tag + "**", joiner.toString(), sideColor, quickPOverallStats.getString("avatar"));
        }
        catch (Exception e)
        {
            e.printStackTrace();
